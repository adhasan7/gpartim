    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
					...
					<input type='radio' name='g' value='level pemilik' checked> Owner &nbsp; 
					<input type='radio' name='g' value='admin'> Administrator &nbsp;
					<input type='radio' name='g' value='level layanan pelanggan' checked> Custumer Service &nbsp;	
					<input type='radio' name='g' value='level koordinator wilayah ' checked> Korwil &nbsp;
					<input type='radio' name='g' value='Sub koordinator' checked> Sub koordinator 
