            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tambah Transaksi Pemesanan</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                <?php 
                  $attributes = array('class'=>'form-horizontal','role'=>'form');
                  echo form_open_multipart('administrator/tambah_pesanan',$attributes); 
                  if ($rows['kode_pesan']==''){
                    $kode_pesan = "PO-".date('YmdHis');
                  }else{
                    $kode_pesan = $rows['kode_pesan'];
                  }
                ?>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <tr><th width='140px' scope='row'>Kode Pesanan</th>  <td><input type='text' class='form-control' value='<?php echo "$kode_pesanan"; ?>' name='a'></td></tr>
                    <tr><th width='140px' scope='row'>Kode Pesanan</th>  <td><input type='text' class='form-control' value='<?php echo "$nama_driver"; ?>' name='a'></td></tr>
