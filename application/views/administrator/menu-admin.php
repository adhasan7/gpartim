        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <!-- menu ojek online versi 2 -->
            <li class="treeview">
              <a href="#"><i class="fa fa-motorcycle"></i> <span>Ojek Online</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <?php
                $cek = $this->model_app->umenu_akses("penawaran", $this->session->id_session);
                if ($cek == 1 or $this->session->level == 'admin') {
                  echo "<li><a href='" . base_url() . $this->uri->segment(1) . "/driver'><i class='fa fa-circle-o'></i> Driver</a></li>";
                }
                $cek = $this->model_app->umenu_akses("pemesanan", $this->session->id_session);
                if ($cek == 1 or $this->session->level == 'admin') {
                  echo "<li><a href='" . base_url() . $this->uri->segment(1) . "/pesanan'><i class='fa fa-circle-o'></i>Pesanan</a></li>";
                }
                ?>
              </ul>
            </li>
            <!-- menu ojek online versi 2 -->
            <!-- ini awal untuk menu ojek online -->
            <li class="treeview">
              <a href="#"><i class="fa fa-car"></i> <span>Transaksi Ojek Online</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <?php
                $cek = $this->model_app->umenu_akses("penawaran", $this->session->id_session);
                if ($cek == 1 or $this->session->level == 'admin') {
                ...
                $cek = $this->model_app->umenu_akses("pemesanan", $this->session->id_session);
                if ($cek == 1 or $this->session->level == 'admin') {
                  echo "<li><a href='" . base_url() . $this->uri->segment(1) . "/pemesanan'><i class='fa fa-circle-o'></i>Pesanan</a></li>";
                }

                $cek = $this->model_app->umenu_akses("pembayaran", $this->session->id_session);
                if ($cek == 1 or $this->session->level == 'admin') {
                  echo "<li><a href='" . base_url() . $this->uri->segment(1) . "/pembayaran'><i class='fa fa-circle-o'></i> Pembayaran</a></li>";
                }

                $cek = $this->model_app->umenu_akses("konfirmasi_pembayaran", $this->session->id_session);
                if ($cek == 1 or $this->session->level == 'admin') {
                  echo "<li><a href='" . base_url() . $this->uri->segment(1) . "/konfirmasi_pembayaran'><i class='fa fa-circle-o'></i> Konfirmasi Pembayaran</a></li>";
                }
                ?>
              </ul>
            </li>
            <!-- ini akhir untuk menu ojek online -->
