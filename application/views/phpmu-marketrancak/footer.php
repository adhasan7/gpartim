                    ...
                    echo "<aside class='widget widget_contact-us'>
                        ...
                        <div class='widget_content'>";
                            ...
                            echo "<ul class='ps-list--social'>
                                <li><a class='facebook' href='https://www.facebook.com/IPB-Cirebon-Institut-Pendidikan-dan-Bahasa-Invada-110523638173555/'><i class='fa fa-facebook'></i></a></li>
                                <li><a class='twitter' href='https://twitter.com/ipb_cirebon?t=w5WANYQLsevbbyJrkLgBKw&s=08'><i class='fa fa-twitter'></i></a></li>
                                <li><a class='google-plus' href='ipbcirebon.invada@gmail.com'><i class='fa fa-google-plus'></i></a></li>
                                <li><a class='instagram' href='https://instagram.com/ipb_cirebon?utm_medium=copy_link'><i class='fa fa-instagram'></i></a></li>
                            </ul>
                        </div>
                    </aside>";
                }else{ 
