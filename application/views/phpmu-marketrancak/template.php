...
<head>
    ...
    <!-- sweet alert -->
    <script src="<?= base_url(); ?>asset/aset/vendor/sweetalert2/dist/sweetalert2.all.min.js"></script>
    ...
    <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=<?= config('facebook_pixel'); ?>&ev=PageView&noscript=1" /></noscript>
...
<body>
                                    ...
                                    <div class="ps-block__right">
                                        ...
                                        if ($this->session->level == 'konsumen') {
                                            ...
                                            echo "<div class='ps-dropdown'>
                                                    ...
                                                    <ul class='ps-dropdown-menu'>";
                                            $data = array('<i class="icon-user"></i> Profile', '<i class="icon-couch"></i> Sosmed', '<i class="icon-bag-dollar"></i> Data Bank', '<i class="fa fa-money"></i> Keuangan', '<i class="icon-heart"></i> Wishlist', '<i class="icon-bag2"></i> Pembelian', '<i class="icon-phone"></i> PPOB', '<i class="icon-bicycle"></i> Ojek', '<i class="icon-car"></i> Jadi Kurir ' . $pesanan_sopir . '');
                                            $link = array('profile', 'sosial_media', 'rekening_bank', 'withdraw', 'wishlist', 'orders_report', 'trx_pulsa', 'ojek_online', 'sopir');
                    ...
                    <div class="header__center">
                        <form class="ps-form--quick-search" action="<?php echo base_url() ?>produk" method="GET">
                            <div class="form-group--icon">
                                <i class="icon-chevron-down" style='z-index:3; padding:10px 10px; text-align:right; width:0.5px;'></i>
                            ...
                            <input class="form-control" name='s' value='<?= cetak($_GET['s']); ?>' type="text" placeholder="Temukan Beragam Produk Pilihanmu disini ..." autocomplete='off' required>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=<?= $this->config->item('google_api') ?>&amp;region=GB"></script>
