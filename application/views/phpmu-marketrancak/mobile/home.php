<header class="header header--mobile" data-sticky="true">
    ...
    <div class="navigation--mobile" style="height: 50px;">
        <div class="navigation__left" style="width:30%">
            <?php
        ...
        <div class="navigation__right" style="height:20px">
            <div class="header__actions" style="height:25px ">
                <?php
    ...
    <div class="ps-search--mobile">
        <form class="ps-form--search-mobile" action="<?php echo base_url() ?>produk" method="GET">
            <div class="form-group--nest">
                <input class="form-control" name='s' type="text" placeholder="Temukan Beragam Produk Pilihanmu Disini ..." required>
        ...
        <div class="ps-cart--mobile">
            <div class="ps-cart__content"><span class='m1keranjangx'>
                    ...
                    foreach ($cek_keranjang->result_array() as $row) {
                        ...
                        if (trim($ex[0]) == '' or !file_exists("asset/foto_produk/" . $ex[0])) {
                            $foto_produk = 'no-image.png';
                        } else {
                            if (!file_exists("asset/foto_produk/thumb_" . $ex[0])) {
                                $foto_produk = $ex[0];
                            } else {
                                $foto_produk = "thumb_" . $ex[0];
                            }
                        }
...
if ($this->session->id_konsumen != '') { ?>
    <div class="ps-panel--sidebar" id="search-sidebar">
        ...
        <div class="ps-panel__content">
            <ul class="menu--mobile">
                <?php
                $data = array('Profile', 'Sosmed', 'Data Bank', 'Keuangan', 'Wishlist', 'Pembelian', 'PPOB', 'Ojek', 'Jadi Kurir ' . $pesanan_sopir . '');
